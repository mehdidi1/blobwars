...
OBJS = strategy.o blobwar.o main.o font.o mouse.o image.o widget.o rollover.o button.o label.o board.o rules.o blob.o network.o bidiarray.o shmem.o greedy.o minimax.o minimax_para.o alpha_beta.o

OBJS_launchComputation = launchStrategy.o strategy.o bidiarray.o shmem.o greedy.o minimax.o minimax_para.o alpha_beta.o
